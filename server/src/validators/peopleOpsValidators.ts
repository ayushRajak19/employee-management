import { z } from "zod"; import { BADGES } from "../models/Recognition.js"; import { LEAVE_TYPES } from "../models/LeaveRequest.js"; import { PERMISSIONS } from "@mobiusbloom/shared"; const objectId = z.string().regex(/^[a-f\d]{24}$/i, "Invalid identifier");
