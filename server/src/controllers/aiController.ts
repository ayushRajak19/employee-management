...
export const assistant = async (request: Request, response: Response): Promise<void> => { response.json({ success: true, message: "Assistant response generated", data: await service.askAssistant(request.body.question, viewer(request), request.body.employeeId) }); };
