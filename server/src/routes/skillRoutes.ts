...
skillRouter.get("/submissions", requireAnyPermission("employee.view", "skill.verify", "department.view"), asyncHandler(controller.submissions));
skillRouter.get("/role-assessment/employee/:employeeId", requireAnyPermission("employee.view", "skill.verify", "department.view"), asyncHandler(controller.employeeRoleCatalog));
skillRouter.post("/role-assessment/employee/:employeeId", requireAnyPermission("skill.verify", "employee.update"), validate(roleSkillAssessmentSchema), asyncHandler(controller.adminSubmitEmployeeRoleCatalog));
