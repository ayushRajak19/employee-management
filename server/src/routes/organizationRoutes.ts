import { Router } from "express"; import * as controller from "../controllers/organizationController.js"; import { authenticate, requirePermission } from "../middleware/auth.js"; import { validate } from "../middleware/validate.js"; import { asyncHandler } from "../utils/asyncHandler.js"; import { departmentSchema, designationSchema, teamSchema, updateDepartmentSchema, updateTeamSchema, updateDesignationSchema, updateDesignationSkillsSchema } from "../validators/organizationValidators.js";
