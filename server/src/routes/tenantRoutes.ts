...
import { createTenantSchema, updateTenantStatusSchema, updateTenantSubscriptionSchema } from "../validators/tenantValidators.js";
...
tenantRouter.patch("/:id/subscription", validate(updateTenantSubscriptionSchema), asyncHandler(controller.updateSubscription));
