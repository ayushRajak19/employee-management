...
export interface BankDetails { accountHolderName?: string; accountNumber?: string; bankName?: string; ifscCode?: string; branchName?: string; }
export interface EmployeeDocument {
  ...
  profilePhotoKey?: string; personal?: { personalEmail?: string; dateOfBirth?: Date; address?: string; emergencyContact?: string; panNumber?: string; aadhaarNumber?: string; taxId?: string };
  bankDetails?: BankDetails;
  workLocation?: { geoNode?: Types.ObjectId; country?: Types.ObjectId; state?: Types.ObjectId; district?: Types.ObjectId; city?: Types.ObjectId; coordinates?: { type: "Point"; coordinates: [number, number] } };
...
const schema = new Schema<EmployeeDocument>({
  ...
  professionalSummary: { type: String, maxlength: 2000 }, previousExperience: { type: [experienceSchema], default: [] },
  workLocation: { geoNode: { type: Schema.Types.ObjectId, ref: "GeoNode", index: true }, country: { type: Schema.Types.ObjectId, ref: "GeoNode" }, state: { type: Schema.Types.ObjectId, ref: "GeoNode" }, district: { type: Schema.Types.ObjectId, ref: "GeoNode" }, city: { type: Schema.Types.ObjectId, ref: "GeoNode" }, coordinates: { type: { type: String, enum: ["Point"] }, coordinates: [{ type: Number }] } },
...
schema.index({ "workLocation.coordinates": "2dsphere" }, { sparse: true });
