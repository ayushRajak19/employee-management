...
export const GeographicSalesPage = () => {
  ...
  return <main className="flex-1 px-5 py-8 sm:px-8">
    <div className="mx-auto max-w-[1440px]">
      ...
      {isEmployeeView ? <CountrySales/> : tree.isLoading ? <Skeleton className="mt-7 h-[420px]"/> : tree.isError ? <p className="mt-7 rounded-xl bg-red-50 p-4 text-red-700">{tree.error.message}</p> : <>
