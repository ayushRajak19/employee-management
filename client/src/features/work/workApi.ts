...
export interface VoiceDraft { action: "CREATE_TASK" | "UPDATE_STATUS"; name?: string; description?: string; project?: string; assignedEmployee?: string; verbalAssigner?: string; priority?: string; complexity?: string; estimatedHours?: number; deadline?: string; task?: string; status?: string; actualHours?: number; completionNote?: string; blockerReason?: string; blockerComment?: string }
