...
export const authApi = {
  ...
  , requestPasswordReset: (body: { email: string }) => api.post("/api/v1/auth/forgot-password", body), resetPassword: (body: { email: string; token: string; newPassword: string }) => api.post("/api/v1/auth/reset-password", body)
};
