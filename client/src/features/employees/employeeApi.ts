...
export interface Employee360 {
  employee: EmployeeRow & { dateOfJoining: string; employmentType: string; officeLocation?: string; professionalSummary?: string };
...
export const employeeApi = {
  ...
  me: () => api.get<{ employee: EmployeeRow & { onboardingStep: number; professionalSummary?: string } }>("/api/v1/employees/me"),
