...
export interface AttendanceRecord { _id: string; dateKey: string; status: "PRESENT" | "LATE" | "HALF_DAY"; checkInAt: string; checkOutAt?: string; workedMinutes: number; checkInLocation: { distanceMeters: number; accuracy: number }; checkOutLocation?: { distanceMeters: number; accuracy: number } }
