...
export interface AutomationSummary { workflows: number; active: number; contacts: number; sent: number; delivered: number; opened: number; clicked: number; replies: number }
