...
export const App = () => <Suspense fallback={<PageLoader/>}><Routes>
  ...
  <Route element={<ProtectedRoute/>}><Route element={<AppLayout/>}>
    ...
    <Route element={<PermissionRoute permissions={["sales.analytics.self","sales.analytics.team","sales.analytics.all"]}/>}> <Route path="sales/my-target" element={<TargetPerformancePage/>}/></Route>
