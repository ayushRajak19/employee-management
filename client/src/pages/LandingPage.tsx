...
export const LandingPage = () => {
  ...
  useEffect(() => { document.title = "MobiusEMS — Run the company, not the chaos."; }, []);
  ...
  return <div className="lp">
    ...
    <header className="lp-nav">
      ...
      <nav aria-label="Main navigation"><Link to="/solutions">All capabilities</Link><Link to="/solutions/employee-360">Employee 360</Link><Link to="/solutions/mobius-ems-ai">MobiusEMS AI</Link><Link to="/solutions/voice-task-assistant">Voice control</Link></nav>
    ...
    <main id="main-content">
          ...
          <div className="lp-app-shell">
            ...
            <div className="lp-app-main">
              ...
              <div className="lp-app-grid">
                ...
                <div className="lp-app-side"><div className="lp-ai-pulse"><span><Sparkles size={15}/> MOBIUSEMS AI</span><strong>What deserves attention?</strong><p>Two reviews are waiting and Operations has the highest estimated workload.</p><button type="button">Open insight <ArrowRight size={13}/></button></div><div className="lp-team-pulse"><span>TEAM PULSE</span><strong>18 of 21</strong><small>people checked in today</small><div><i/><i/><i/><i/></div></div></div>
              </div>
      ...
      <section className="lp-showroom">
        ...
        <div className="lp-showroom-scene" style={{ "--scene-accent": active.accent } as CSSProperties}>
          ...
          <div className="lp-showroom-ui" aria-live="polite"><div className="lp-ui-head"><span/><span/><span/><p>mobius-ems / {activeView.toLowerCase().replace(" ", "-")}</p></div>
    ...
    <footer className="lp-footer"><Link to="/welcome" className="lp-brand"><img src={logo} alt=""/><span>MobiusEMS</span></Link><p>A flagship product of Mobius Bloom Venture Pvt Ltd</p><div><Link to="/solutions">Capabilities</Link><Link to="/solutions/mobius-ems-ai">AI</Link><Link to={user ? "/" : "/login"}>Workspace ↗</Link></div></footer>
  </div>;
};
