...
import { Building2, Download, FileText, Trash2, Upload, Users } from "lucide-react";
...
export const ResumesPage = () => {
  ...
  const remove = useMutation({
    mutationFn: governanceApi.deleteDocument,
    onSuccess: async () => { await queryClient.invalidateQueries({ queryKey: ["resumes"] }); }
  });
