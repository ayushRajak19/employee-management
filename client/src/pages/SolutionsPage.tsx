...
import { ArrowLeft, ArrowRight, Award, Bot, BriefcaseBusiness, Check, FileSearch, Fingerprint, MailCheck, Mic, ShieldCheck, Target, Users } from "lucide-react";
...
const ProductVisual = ({ solution, index }: { solution: Solution; index: number }) => <div className={`sol-visual visual-${index % 3}`}>
  ...
  <div className="sol-float"><Award size={15}/><span><small>CONNECTED SIGNAL</small><strong>{solution.value.split(".")[0]}</strong></span></div>
</div>;
